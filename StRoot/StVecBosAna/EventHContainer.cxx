...
void EventHContainer::BookHists()
{
   ...
   o["hTrackRecoilWithNeutralsPt"] = hist = new TH1F("hTrackRecoilWithNeutralsPt", "Recoil from Tracks: TPS+emCal (also untracked clustera) ; Track-based Recoil P_{T}; Events", 40, 0, 40);
