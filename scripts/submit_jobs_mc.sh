...
do
   ...
   star-submit-template -template scripts/run11_job_template_mc.xml -entities OUT_DIR=$OUT_DIR,codePath=$CODE_DIR,RUNLIST_ID=$RUNLIST_ID,STAR_VER=$STAR_VER,STANA_OPTIONS=$STANA_OPTIONS
   echo
done
