...
<li>Asymmetry sine fits with phase=0 and offset=0
   ...
   <ul>
   <li><a href="plots.php?ana=run11_pp_transverse_0fixfit&at=">Plain asymmetry</a>
   <li><a href="plots.php?ana=run11_pp_transverse_0fixfit&at=phys">"Square root" formula: physics asymmetry</a>
   <li><a href="plots.php?ana=run11_pp_transverse_0fixfit&at=geom">"Square root" formula: geometry asymmetry</a>
   <li><a href="plots.php?ana=run11_pp_transverse_0fixfit&at=lumi">"Square root" formula: luminosity asymmetry</a>
   </ul>

<li>Asymmetry sine fits with free parameters

   <ul>
   <li><a href="plots.php?ana=run11_pp_transverse_3parfit&at=">Plain asymmetry</a>
