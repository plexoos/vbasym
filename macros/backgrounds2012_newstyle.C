void backgrounds2012_newstyle()
{
   ...
   TString outPath       = "~/vbasym_results/plots/2012/test";
   ...
   //float lumiData12Tot       = 77;// pb-1
   //float lumiData12Eff       = 77;// pb-1
   ...
   TFile *fileMCZ    = TFile::Open(inPathNew + "run12_mc_Z2ee.lis/hist/vbana.root");
   TFile *fileMCWptt = TFile::Open(inPathNew + "run12_mc_Wp2tautau.lis/hist/vbana.root");
   TFile *fileMCWmtt = TFile::Open(inPathNew + "run12_mc_Wm2tautau.lis/hist/vbana.root");
...
// W+
   ...
   TLatex *textWp = new TLatex(0.2, 0.85, "W^{+} #rightarrow e^{+} #nu_{e}");
   textWp -> SetNDC(); 
   textWp -> SetTextFont(32);
   textWp -> SetTextSize(0.06);
   TLatex *textWm = new TLatex(0.2, 0.85, "W^{-} #rightarrow e^{-} #nu_{e}");
   textWm -> SetNDC(); 
