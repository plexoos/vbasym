...
void PtCorrPlot_2012()
{
   ...
   TString outPath       = "~/vbasym_results/plots/2012/PtCorrPlot";
   ...
   TFile *fileData          = TFile::Open(inPathNew + "run12_pp_long_j3/hist/vbana.root");
   TFile *fileMCWp          = TFile::Open(inPathNew + "run12_mc_Wp2enu.lis/hist/vbana.root");
   //TFile *fileMCWp_TuneA    = TFile::Open(inPathNew + "run12_mc_Wp2enu_tuneA.lis/hist/vbana.root");
   //TFile *fileMCWpOld       = TFile::Open(inPath + "run12_mc_Wp2enu.lis_-m_-w_--jpm_0.5_vbana_OldStylePtCorr.root");
   TFile *fileMCWm          = TFile::Open(inPathNew + "run12_mc_Wm2enu.lis/hist/vbana.root");
...
//*** CREATE ROOT FILE FOR CURVES FROM ASCII FILE ***
   ...
   dirCurves.ReplaceAll("PtCorrPlot_2012.C","");
   ...
   Float_t y,pt,an;
   Int_t nlines = 0;
   TFile   *fAnEvol  = new TFile("./ZK_evolution_Wp_asymmetry_2012.root","RECREATE");
...
//***************************************************
   ...
   TH2 *hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco   = (TH2 *)fileMCWp->Get("event_mc/hTrackRecoilTpcNeutralsPt_GenOverReco_zdc100k-200k");
   TH2 *hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco   = (TH2 *)fileMCWp->Get("event_mc/hTrackRecoilTpcNeutralsPt_GenOverReco_zdc200k-300k");
   TH2 *hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco   = (TH2 *)fileMCWp->Get("event_mc/hTrackRecoilTpcNeutralsPt_GenOverReco_zdc300k-400k");
   ...
   // Luminosities for run 12
   float lumiDataTot       = 85.853;// pb-1
   float lumiDataEff       = 85.853;// pb-1
   float lumiMC_Z          = 1045;  // pb-1
   float lumiMC_WpToENU    = 1106;  // pb-1
   float lumiMC_WmToENU    = 1101;  // pb-1
   ...
   c2b_paper->SaveAs(outPath + "/PaperPlot_PtCorr.png");
   c2b_paper->SaveAs(outPath + "/PaperPlot_PtCorr.eps");
   ...
   TCanvas *cPtCorrFact_ZDC100k200k   = new TCanvas("cPtCorrFact_ZDC100k200k", "W+ Pt correction factor for ZDC rate 100k - 200k", 800, 500);

   cPtCorrFact_ZDC100k200k -> cd();
   cPtCorrFact_ZDC100k200k -> SetLogz(1);
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco  -> SetTitle("W^{+} - ZDC rate 100k - 200k");
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco  -> GetXaxis() -> SetTitle("Recoil P_{T}");
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco  -> SetStats(0);
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco  -> Draw();

   cPtCorrFact_ZDC100k200k -> SaveAs(outPath + "/plot_PtCorrFactor_ZDC100k200k.png");
   cPtCorrFact_ZDC100k200k -> SaveAs(outPath + "/plot_PtCorrFactor_ZDC100k200k.eps");

   TCanvas *cPtCorrFact_ZDC200k300k   = new TCanvas("cPtCorrFact_ZDC200k300k", "W+ Pt correction factor for ZDC rate 200k - 300k", 800, 500);

   cPtCorrFact_ZDC200k300k -> cd();
   cPtCorrFact_ZDC200k300k -> SetLogz(1);
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco  -> SetTitle("W^{+} - ZDC rate 200k - 300k");
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco  -> GetXaxis() -> SetTitle("Recoil P_{T}");
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco  -> SetStats(0);
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco  -> Draw();

   cPtCorrFact_ZDC200k300k -> SaveAs(outPath + "/plot_PtCorrFactor_ZDC200k300k.png");
   cPtCorrFact_ZDC200k300k -> SaveAs(outPath + "/plot_PtCorrFactor_ZDC200k300k.eps");

   TCanvas *cPtCorrFact_ZDC300k400k   = new TCanvas("cPtCorrFact_ZDC300k400k", "W+ Pt correction factor for ZDC rate 300k - 400k", 800, 500);

   cPtCorrFact_ZDC300k400k -> cd();
   cPtCorrFact_ZDC300k400k -> SetLogz(1);
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco  -> SetTitle("W^{+} - ZDC rate 300k - 400k");
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco  -> GetXaxis() -> SetTitle("Recoil P_{T}");
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco  -> SetStats(0);
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco  -> Draw();

   cPtCorrFact_ZDC300k400k -> SaveAs(outPath + "/plot_PtCorrFactor_ZDC300k400k.png");
   cPtCorrFact_ZDC300k400k -> SaveAs(outPath + "/plot_PtCorrFactor_ZDC300k400k.eps");
   ...
   */
   ...
   hWp_PtRecoil_vs_Pt_GenOverReco_pfx -> SetLineColor(kRed);
   hWm_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerStyle(20);
   hWm_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerColor(kBlue);
   hWm_PtRecoil_vs_Pt_GenOverReco_pfx -> SetLineColor(kBlue);

   hWm_PtRecoil_vs_Pt_GenOverReco_pfx -> Draw("E1");
   hWp_PtRecoil_vs_Pt_GenOverReco_pfx -> Draw("E1 same");
   ...
   TCanvas *cPtCorrFact_ZDC_pfx   = new TCanvas("cPtCorrFact_ZDC_pfx", "Pt correction factor different ZDC rates", 800, 500);

   cPtCorrFact_ZDC_pfx -> cd();
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco -> ProfileX("hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco_pfx",1,-1);
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetTitle("; Recoil P_{T}; Correction Factor");
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerStyle(20);
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerColor(kGreen);

   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco -> ProfileX("hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco_pfx",1,-1);
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetTitle("; Recoil P_{T}; Correction Factor");
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerStyle(20);
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerColor(kBlue);

   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco -> ProfileX("hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco_pfx",1,-1);
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetTitle("; Recoil P_{T}; Correction Factor");
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerStyle(20);
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco_pfx -> SetMarkerColor(kRed);

   hWp_PtRecoil_vs_Pt_GenOverReco_pfx             -> SetMarkerColor(kBlack);
   hWp_PtRecoil_vs_Pt_GenOverReco_pfx             -> Draw("E1");
   hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco_pfx -> Draw("E1 same");
   hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco_pfx -> Draw("E1 same");
   hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco_pfx -> Draw("E1 same");
  
   TLegend *legPtCorrFact_ZDC_pfx = new TLegend(0.5, 0.75, 0.75, 0.9); 
   legPtCorrFact_ZDC_pfx -> AddEntry(hWp_ZDC100k200k_PtRecoil_vs_Pt_GenOverReco_pfx,"W^{+}, ZDC rate 100k - 200k ", "P");
   legPtCorrFact_ZDC_pfx -> AddEntry(hWp_ZDC200k300k_PtRecoil_vs_Pt_GenOverReco_pfx,"W^{+}, ZDC rate 200k - 300k ", "P");
   legPtCorrFact_ZDC_pfx -> AddEntry(hWp_ZDC300k400k_PtRecoil_vs_Pt_GenOverReco_pfx,"W^{+}, ZDC rate 300k - 400k ", "P");
   legPtCorrFact_ZDC_pfx -> AddEntry(hWp_PtRecoil_vs_Pt_GenOverReco_pfx,"W^{+}", "P");
   legPtCorrFact_ZDC_pfx -> Draw();;

   cPtCorrFact_ZDC_pfx->SaveAs(outPath + "/plot_PtCorrFactor_ZDC_ProfileX.png");
   cPtCorrFact_ZDC_pfx->SaveAs(outPath + "/plot_PtCorrFactor_ZDC_ProfileX.eps");
